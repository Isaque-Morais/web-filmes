<div class="w-full bg-white h-[96px] drop-shadow-lg flex flex-row items-center">
    <div class="w-1/3 pl-5">
        <a href="/filmes" class="uppercase text-base mx-5 text-black hover:text-develobe-500 duration-200 fonte-inter">Filmes</a>
    ...
    <div class="w-1/3 flex items-center justify-center">
        <a href="/" class="font-bold text-5xl font-quicksand text-black hover:text-develobe-500 durantion-200">CINETECH</a>   
    </div> 

    <div class="w-1/3 flex flex-row justify-end pr-10">
        <a href="/pesquisa" class="group">
